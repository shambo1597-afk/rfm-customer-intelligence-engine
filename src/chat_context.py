...
"CustomerID" from either dataset to an LLM API -- including Gemini's free tier,
where content may be used to improve Google's products (see
digest_engine.py's data-usage disclosure) -- carries no real personal-privacy
exposure, because there is no real person behind either ID.
